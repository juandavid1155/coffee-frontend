            ...
            <Container className="grid lg:grid-cols-2 gap-12 lg:gap-16 2xl:gap-24 items-center">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-10">
                        <div>
                            <p className="text-zinc-500 mb-2 text-sm 2xl:text-base uppercase tracking-wider">Origen</p>
                            <p className="text-lg lg:text-xl 2xl:text-2xl">{product.origin}</p>
                        </div>
                        <div>
                            <p className="text-zinc-500 mb-2 text-sm 2xl:text-base uppercase tracking-wider">Proceso</p>
                            <p className="text-lg lg:text-xl 2xl:text-2xl">{product.process}</p>
                        </div>
                    </div>
